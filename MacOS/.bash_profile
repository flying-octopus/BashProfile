...
#   ------------------------------------------------------------   
    source /Library/Developer/CommandLineTools/usr/share/git-core/git-completion.bash						# File included in repository, required for tab complition of git commands
		
#   Change Prompt
#   ------------------------------------------------------------
    source /Library/Developer/CommandLineTools/usr/share/git-core/git-prompt.sh								# You need to import that for (__git_ps1) to work properly, file included in repository
